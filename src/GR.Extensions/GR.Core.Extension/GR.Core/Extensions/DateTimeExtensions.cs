...
namespace GR.Core.Extensions
{
    public static class DateTimeExtensions
    {
        ...
        public static DateTime? StringToDateTime(this string value)
        {
            ...
            if (DateTime.TryParseExact(value, "dd/MM/yyyy", CultureInfo.InvariantCulture, DateTimeStyles.None, out dDate))
                return dDate;
            ...
            if (DateTime.TryParseExact(value, "M/d/yyyy", new CultureInfo("en-US"), DateTimeStyles.None, out dDate))
                return dDate;

            if (DateTime.TryParse(value, out dDate))
                return DateTime.Parse(value) != DateTime.MinValue ? DateTime.Parse(value) : (DateTime?)null;
