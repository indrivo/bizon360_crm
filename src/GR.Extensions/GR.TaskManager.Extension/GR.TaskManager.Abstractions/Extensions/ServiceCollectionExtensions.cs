...
namespace GR.TaskManager.Abstractions.Extensions
{
    public static class ServiceCollectionExtensions
    {
        ...
        /// <param name="services"></param>
        /// <returns></returns>
        public static IServiceCollection AddTaskTypeModule<TService, TContext>(this IServiceCollection services)
            where TService : class, ITaskTypeService
            where TContext : DbContext, ITaskManagerContext
        {
            services.AddGearTransient<ITaskTypeService, TService>();
            services.AddTransient<ITaskManagerContext, TContext>();
            return services;
        }
